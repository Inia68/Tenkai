...
public class TimerExecutor<T>
{
     ...
     * @return {@code true} if timer were successfully added, {@code false} in case it exists already
     */
    public boolean addTimer(T event, StatSet params, long time, L2Npc npc, L2PcInstance player, IEventTimerEvent<T> eventTimer)
    {
     ...
     * @return {@code true} if timer were successfully added, {@code false} in case it exists already
     */
    public boolean addTimer(T event, StatSet params, long time, L2Npc npc, L2PcInstance player)
    {
     ...
     * @return {@code true} if timer were successfully added, {@code false} in case it exists already
     */
    private boolean addRepeatingTimer(T event, StatSet params, long time, L2Npc npc, L2PcInstance player, IEventTimerEvent<T> eventTimer)
    {
